...
\newcommand\grauTitulo{Bacharel em Engenharia Elétrica}  
...
\data{08}{Janeiro}{2025} % Exemplo: \data{21}{Março}{2016}
...
% ----------------------------------------------------------
% Folha de aprovação
\include{pre-textual/00.Approvation}

% Dedicatória
% \include{pre-textual/01.Dedication}

% Agradecimentos
\include{pre-textual/02.Acknowledgment}

% Epigrafe (opcional)
\include{pre-textual/03.Epigraph}

%% RESUMO
\include{pre-textual/04.Abstract_pt}

% Abstract
\begin{otherlanguage}{english}
  \include{pre-textual/05.Abstract_en}
\end{otherlanguage}
...
% \include{pre-textual/06.AbbreviationList}
% \include{pre-textual/07.SymbolList}
% ----------------------------------------------------------
...
\include{chapters/1-basic-concepts.tex}
\include{chapters/2-codeboard.tex}
\include{chapters/3-cloud.tex}
\include{chapters/4-test-results.tex}
