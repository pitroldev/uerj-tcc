...
% A infraestrutura do MongoDB Atlas foi configurada para garantir alta disponibilidade e recuperação de desastres, com replicação de dados em múltiplas zonas de disponibilidade e backups automáticos diários.
...
% TODO: Diagrama de escalabilidade vertical do MongoDB Atlas
